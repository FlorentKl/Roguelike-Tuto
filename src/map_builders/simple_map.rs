use super::{
    common::create_horizontal_tunnel, common::create_vertical_tunnel, BuilderMap,
...
impl SimpleMapBuilder {
    ...
    fn build_rooms(&mut self, rng: &mut RandomNumberGenerator, build_data: &mut BuilderMap) {
        ...
        //Not all algorithms support rooms -
        //so our trait leaves the Option set to None until we fill it.
        //Since the SimpleMapBuilder is all about rooms - we fill it in.
