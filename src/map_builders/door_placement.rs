...
impl DoorPlacement {
    ...
    fn doors(&mut self, rng: &mut RandomNumberGenerator, build_data: &mut BuilderMap) {
        //checking that there is corridor information to use
    ...
    ///There really are only two places in which a door makes sense:
    ///with east-west open and north-south blocked, and vice versa.
